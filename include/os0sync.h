...
ib_int64_t os_event_reset(os_event_t event); /*!< in: event to reset */
...
ulint os_event_wait_multiple(ulint n, /*!< in: number of events in the
                                      array */
...
#define os_atomic_increment_ulint(ptr, amount) atomic_add_long_nv(ptr, amount)
