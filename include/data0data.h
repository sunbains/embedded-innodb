...
UNIV_INLINE
void dfield_set_type(dfield_t *field, /*!< in: SQL data field */
...
UNIV_INLINE
ibool dfield_datas_are_binary_equal(const dfield_t *field1,  /*!< in: field */
...
@return	nth field */
UNIV_INLINE
dfield_t *dtuple_get_nth_field(const dtuple_t *tuple, /*!< in: tuple */
...
/*** Gets number of fields used in record comparisons. */
UNIV_INLINE
void dtuple_set_n_fields_cmp(dtuple_t *tuple,     /*!< in: tuple */
...
UNIV_INLINE
dtuple_t *dtuple_create(mem_heap_t *heap, /*!< in: memory heap where the tuple
                                          is created */
...
UNIV_INLINE
ulint dtuple_fold(const dtuple_t *tuple, /*!< in: the tuple */
