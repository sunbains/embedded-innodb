...
struct Page_id {
   ...
   */
  Page_id(space_id_t space_id, page_no_t page_no = NULL_PAGE_NO) noexcept
    : m_space_id(space_id), m_page_no(page_no) {}

  bool operator==(const Page_id &rhs) const noexcept {
  ...
  [[nodiscard]] bool is_null() const noexcept {
    return m_space_id == NULL_SPACE_ID && m_page_no == NULL_PAGE_NO;
  }
...
template <typename T> using Page_id_hash = std::unordered_map<Page_id, T, Page_id::Hash>;
