...
struct Page_id {
   ...
   */
  Page_id(space_id_t space_id, page_no_t page_no) noexcept
  ...
  [[nodiscard]] bool is_null() const noexcept {
    ut_ad((m_space_id == NULL_SPACE_ID && m_page_no == NULL_PAGE_NO) ||
          (m_space_id != NULL_SPACE_ID && m_page_no != NULL_PAGE_NO));
