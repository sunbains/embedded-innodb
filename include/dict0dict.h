...
UNIV_INLINE
void dict_col_copy_type(const dict_col_t *col, /*!< in: column */
...
@return	TRUE */
UNIV_INLINE
ibool dict_col_type_assert_equal(const dict_col_t *col, /*!< in: column */
...
@return	minimum size */
UNIV_INLINE
ulint dict_col_get_min_size(const dict_col_t *col); /*!< in: column */
...
UNIV_INLINE
ulint dict_col_get_sql_null_size(
    const dict_col_t *col, /*!< in: column */
    ulint comp);           /*!< in: nonzero=ROW_FORMAT=COMPACT  */
...
dict_table_t *dict_table_get(const char *table_name, /*!< in: table name */
                             ibool inc_count); /*!< in: whether to increment the
...
UNIV_INLINE
ulint dict_index_is_clust(const dict_index_t *index) /*!< in: index */
    __attribute__((pure));
...
UNIV_INLINE
ulint dict_table_get_n_user_cols(const dict_table_t *table); /*!< in: table */
/** Gets the number of system columns in a table in the dictionary cache.
@return	number of system (e.g., ROW_ID) columns of a table */
UNIV_INLINE
ulint dict_table_get_n_sys_cols(const dict_table_t *table); /*!< in: table */
/** Gets the number of all columns (also system) in a table in the dictionary
cache.
@return	number of columns of a table */
UNIV_INLINE
ulint dict_table_get_n_cols(const dict_table_t *table); /*!< in: table */
#ifdef UNIV_DEBUG
/** Gets the nth column of a table.
@return	pointer to column object */
UNIV_INLINE
dict_col_t *dict_table_get_nth_col(const dict_table_t *table, /*!< in: table */
                                   ulint pos); /*!< in: position of column */
/** Gets the given system column of a table.
@return	pointer to column object */
UNIV_INLINE
dict_col_t *dict_table_get_sys_col(const dict_table_t *table, /*!< in: table */
...
UNIV_INLINE
ulint dict_index_get_min_size(const dict_index_t *index); /*!< in: index */
#endif                                                    /* !UNIV_HOTBACKUP */
...
UNIV_INLINE
ulint dict_table_get_format(const dict_table_t *table); /*!< in: table */
/** Set the file format of a table. */
UNIV_INLINE
void dict_table_set_format(dict_table_t *table, /*!< in/out: table */
                           ulint format);       /*!< in: file format version */
/** Extract the compressed page size from table flags.
@return	compressed page size, or 0 if not compressed */
UNIV_INLINE
ulint dict_table_flags_to_zip_size(ulint flags) /*!< in: flags */
    __attribute__((const));
/** Check whether the table uses the compressed compact page format.
@return	compressed page size, or 0 if not compressed */
UNIV_INLINE
ulint dict_table_zip_size(const dict_table_t *table); /*!< in: table */
...
@return	column number */
UNIV_INLINE
ulint dict_index_get_nth_col_no(const dict_index_t *index, /*!< in: index */
                                ulint pos); /*!< in: position of the field */
...
UNIV_INLINE
ulint dict_index_get_sys_col_pos(const dict_index_t *index, /*!< in: index */
...
@return	space id */
UNIV_INLINE
ulint dict_index_get_space(const dict_index_t *index); /*!< in: index */
...
@return	page number */
UNIV_INLINE
ulint dict_index_get_page(const dict_index_t *tree); /*!< in: index */
/** Sets the page number of the root of index tree. */
UNIV_INLINE
void dict_index_set_page(dict_index_t *index, /*!< in/out: index */
