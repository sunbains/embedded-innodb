...
#define UT_SORT_FUNCTION_BODY(CMP_CTX, SORT_FUN, ARR, AUX_ARR, LOW, HIGH, CMP_FUN)        \
  {                                                                                       \
    ulint ut_sort_mid77;                                                                  \
    ulint ut_sort_i77;                                                                    \
    ulint ut_sort_low77;                                                                  \
    ...
    for (ut_sort_i77 = (LOW); ut_sort_i77 < (HIGH); ut_sort_i77++) {                      \
      ...
      if (ut_sort_low77 >= ut_sort_mid77) {                                               \
        ...
        ut_sort_low77++;                                                                  \
      } else if (CMP_FUN((CMP_CTX), (ARR)[ut_sort_low77], (ARR)[ut_sort_high77]) > 0) {   \
        (AUX_ARR)[ut_sort_i77] = (ARR)[ut_sort_high77];                                   \
        ut_sort_high77++;                                                                 \
      } else {                                                                            \
        (AUX_ARR)[ut_sort_i77] = (ARR)[ut_sort_low77];                                    \
        ut_sort_low77++;                                                                  \
                                                                                          ...
                                                                                          \
    memcpy((void *)((ARR) + (LOW)), (AUX_ARR) + (LOW), ((HIGH) - (LOW)) * sizeof *(ARR)); \
  }
