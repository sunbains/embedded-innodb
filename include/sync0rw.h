...
UNIV_INLINE
void rw_lock_s_unlock_direct(rw_lock_t *lock); /*!< in/out: rw-lock */
/** Releases an exclusive mode lock when we know there are no waiters, and
none else will access the lock durint the time this function is executed. */
UNIV_INLINE
void rw_lock_x_unlock_direct(rw_lock_t *lock); /*!< in/out: rw-lock */
...
UNIV_INLINE
ibool rw_lock_lock_word_decr(rw_lock_t *lock, /*!< in/out: rw-lock */
