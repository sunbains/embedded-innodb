...
buf_block_t *fseg_create(ulint space, ulint page, ulint byte_offset, mtr_t *mtr);
...
uint64_t fsp_get_available_space_in_free_extents(ulint space); /*!< in: space id */
...
inline bool fsp_descr_page(ulint page_no) {
