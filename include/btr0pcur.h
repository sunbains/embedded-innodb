...
UNIV_INLINE
void btr_pcur_open_at_rnd_pos_func(
    dict_index_t *index, /*!< in: index */
    ulint latch_mode,    /*!< in: BTR_SEARCH_LEAF, ... */
...
UNIV_INLINE
void btr_pcur_set_mtr(btr_pcur_t *cursor, /*!< in: persistent cursor */
                      mtr_t *mtr);        /*!< in, own: mtr */
/*** Gets the mtr field for a pcur.
@return	mtr */
UNIV_INLINE
mtr_t *btr_pcur_get_mtr(btr_pcur_t *cursor); /*!< in: persistent cursor */
...
UNIV_INLINE
ibool btr_pcur_is_detached(btr_pcur_t *pcur); /*!< in: persistent cursor */
...
UNIV_INLINE
page_t *btr_pcur_get_page(btr_pcur_t *cursor); /*!< in: persistent cursor */
...
UNIV_INLINE
rec_t *btr_pcur_get_rec(btr_pcur_t *cursor); /*!< in: persistent cursor */
...
#define BTR_PCUR_IS_POSITIONED                                                 \
  1997660512 /* TODO: currently, the state                                     \
...
inline
void btr_pcur_detach(btr_pcur_t *pcur) /*!< in: persistent cursor */
{
  ut_a(pcur->pos_state == BTR_PCUR_IS_POSITIONED);
