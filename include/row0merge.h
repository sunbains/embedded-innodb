...
void row_merge_drop_temp_indexes(ib_recovery_t recovery); /*!< in: recovery level setting */
...
db_err row_merge_rename_tables(
  dict_table_t *old_table, /*!< in/out: old table, renamed
                                                 to tmp_name */
...
db_err row_merge_rename_indexes(
  trx_t *trx, /*!< in/out: transaction */
  dict_table_t *table
