...
que_node_t *
pars_function_declaration(sym_node_t *sym_node); /** in: function id node in
                                                 the symbol table */
...
pars_create_table(sym_node_t *table_sym, /** in: table name node in the symbol
                  ...
                  void *not_fit_in_memory); /** in: a non-NULL pointer means
...
que_fork_t *pars_stored_procedure_call(
...
void pars_info_add_uint64_literal(pars_info_t *info, /** in: info struct */
                                  const char *name,  /** in: name */
                                  uint64_t val);       /** in: value */
/** Add user function. */
