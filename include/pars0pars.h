...
que_node_t *pars_cursor_declaration(
  sym_node_t *sym_node, /** in: cursor id node in the
                                                  symbol     table */
...
que_node_t *pars_function_declaration(sym_node_t *sym_node); /** in: function id node in
                                                 the symbol table */
...
open_node_t *pars_open_statement(
...
row_printf_node_t *pars_row_printf_statement(sel_node_t *sel_node); /** in: select node */
...
que_fork_t *pars_stored_procedure_call(sym_node_t *sym_node); /** in: stored procedure name */
...
void pars_info_add_str_literal(
  pars_info_t *info, /** in: info struct */
  const char *name,  /** in: name */
  const char *str
); /** in: string */
...
void pars_info_add_int4_literal(
  pars_info_t *info, /** in: info struct */
  const char *name,  /** in: name */
  lint val
); /** in: value */
...
void pars_info_add_int8_literal(
  pars_info_t *info, /** in: info struct */
  const char *name,  /** in: name */
  uint64_t val
); /** in: value */
...
void pars_info_add_uint64_literal(
  pars_info_t *info, /** in: info struct */
  const char *name,  /** in: name */
  uint64_t val
); /** in: value */
