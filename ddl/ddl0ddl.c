...
ulint ddl_get_background_drop_list_len_low(void) {
...
ulint ddl_drop_table(const char *name, /*!< in: table name */
...
ulint ddl_create_table(dict_table_t *table, /*!< in: table definition */
                       trx_t *trx)          /*!< in: transaction handle */
{
  tab_node_t *node;
  mem_heap_t *heap;
...
ulint ddl_create_index(dict_index_t *index, /*!< in: index definition */
                       trx_t *trx)          /*!< in: transaction handle */
{
  ulint err;
...
enum db_err ddl_truncate_table(dict_table_t *table, /*!< in: table handle */
                               trx_t *trx) /*!< in: transaction handle */
{
  dict_foreign_t *foreign;
  enum db_err err;
...
ulint ddl_drop_index(dict_table_t *table, /*!< in: table instance */
...
@return	error code or DB_SUCCESS */
static int ddl_delete_constraint_low(const char *id, /*!< in: constraint id */
                                     trx_t *trx) /*!< in: transaction handle */
{
  pars_info_t *info = pars_info_create();
...
ulint ddl_rename_table(const char *old_name, /*!< in: old table name */
...
enum db_err
ddl_drop_database(const char *name, /*!< in: database name which ends in '/' */
                  trx_t *trx)       /*!< in: transaction handle */
{
  char *table_name;
