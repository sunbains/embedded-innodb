...
ulint trx_undo_add_page(trx_t *trx,       /*!< in: transaction */
                        trx_undo_t *undo, /*!< in: undo log memory object */
                        mtr_t *mtr) /*!< in: mtr which does not have a latch to
...
#else
  undo = trx_undo_mem_create(rseg, id, type, trx_id, NULL, page_no, offset);
#endif /* WITH_XOPEN */
...
#else
    err = trx_undo_create(trx, rseg, type, trx->id, NULL, &undo, &mtr);
#endif /* WITH_OPEN */
