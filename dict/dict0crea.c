...
static ulint
dict_foreign_eval_sql(pars_info_t *info,   /*!< in: info struct, or NULL */
...
the database.
@return	error code or DB_SUCCESS */
static ulint dict_create_add_foreign_field_to_dictionary(
...
@return	error code or DB_SUCCESS */
static ulint dict_create_add_foreign_to_dictionary(
...
ulint dict_create_add_foreigns_to_dictionary(
    ...
    trx_t *trx)          /*!< in: transaction */
{
  ...
  if (NULL == dict_table_get_low("SYS_FOREIGN")) {
    ib_logger(ib_stream, "InnoDB: table SYS_FOREIGN not found"
  ...
  for (foreign = UT_LIST_GET_FIRST(table->foreign_list); foreign;
    ...
    error = dict_create_add_foreign_to_dictionary(&number, table, foreign, trx);
