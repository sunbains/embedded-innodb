...
UNIV_INLINE
void mtr_memo_slot_release(mtr_t *mtr,            /*!< in: mtr */
...
/** Releases the mlocks and other objects stored in an mtr memo. They are
released in the order opposite to which they were pushed to the memo. NOTE! It
is essential that the x-rw-lock on a modified buffer page is not released before
...
destroyed. */
UNIV_INLINE
void mtr_memo_pop_all(mtr_t *mtr) /*!< in: mtr */
{
 ...
 */
static void mtr_log_reserve_and_write(mtr_t *mtr,     /*!< in: mtr */
