...
static ulint row_undo_mod_clust(undo_node_t *node, /*!< in: row undo node */
                                que_thr_t *thr)    /*!< in: query thread */
{
  btr_pcur_t *pcur;
  mtr_t mtr;
...
static ulint
row_undo_mod_del_mark_or_remove_sec(undo_node_t *node, /*!< in: row undo node */
                                    que_thr_t *thr,    /*!< in: query thread */
                                    dict_index_t *index, /*!< in: index */
                                    dtuple_t *entry)     /*!< in: index entry */
{
    ...
    const dtuple_t *entry) /*!< in: index entry */
{
  ...
  if (UNIV_UNLIKELY(!row_search_index_entry(index, entry, mode, &pcur, &mtr))) {
    ib_logger(ib_stream, "InnoDB: error in sec index entry del undo in\n"
                         "InnoDB: ");
...
static void
row_undo_mod_parse_undo_rec(ib_recovery_t recovery, /*!< in: recovery flag */
                            undo_node_t *node,      /*!< in: row undo node */
                            que_thr_t *thr)         /*!< in: query thread */
{
