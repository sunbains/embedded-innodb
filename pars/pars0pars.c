                       ...
                       que_node_t *exp)    /*!< in: value to assign */
{
  ...
  node = mem_heap_alloc(pars_sym_tab_global->heap, sizeof(col_assign_node_t));
...
elsif_node_t *
pars_elsif_element(que_node_t *cond,      /*!< in: if-condition */
...
if_node_t *
pars_if_statement(que_node_t *cond,      /*!< in: if-condition */
                  que_node_t *stat_list, /*!< in: statement list */
...
while_node_t *
pars_while_statement(que_node_t *cond,      /*!< in: while-condition */
                     que_node_t *stat_list) /*!< in: statement list */
{
  while_node_t *node;
...
return_node_t *pars_return_statement(void) {
  ...
  node = mem_heap_alloc(pars_sym_tab_global->heap, sizeof(return_node_t));
                          ...
                          que_node_t *val) /*!< in: value to assign */
{
  ...
  node = mem_heap_alloc(pars_sym_tab_global->heap, sizeof(assign_node_t));
...
row_printf_node_t *
pars_row_printf_statement(sel_node_t *sel_node) /*!< in: select node */
{
  row_printf_node_t *node;

  node = mem_heap_alloc(pars_sym_tab_global->heap, sizeof(row_printf_node_t));
                  ...
                  in the buffer */
{
  ...
  len = pars_sym_tab_global->string_len - pars_sym_tab_global->next_char_pos;
  if (len == 0) {
#ifdef YYDEBUG
  ...
  if (pars_print_lexed) {
    ...
    fwrite(pars_sym_tab_global->sql_string + pars_sym_tab_global->next_char_pos,
           1, len, ib_stream);
  }
#endif /* UNIV_SQL_DEBUG */
                ...
                const char *str)   /*!< in: SQL string */
{
  ...
  pars_sym_tab_global->sql_string =
...
que_thr_t *pars_complete_graph_for_exec(
...
void pars_info_add_dulint_literal(pars_info_t *info, /*!< in: info struct */
                                  const char *name,  /*!< in: name */
                                  dulint val)        /*!< in: value */
{
...
void pars_info_add_id(pars_info_t *info, /*!< in: info struct */
                      const char *name,  /*!< in: name */
                      const char *id)    /*!< in: id */
{
  pars_bound_id_t *bid;
...
pars_user_func_t *
pars_info_get_user_func(pars_info_t *info, /*!< in: info struct */
...
pars_bound_lit_t *
pars_info_get_bound_lit(pars_info_t *info, /*!< in: info struct */
...
pars_bound_id_t *
pars_info_get_bound_id(pars_info_t *info, /*!< in: info struct */
